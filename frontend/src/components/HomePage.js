...
function HomePage() {
  ...
  return (
    <div className="homepage m-0 p-0 w-full  bg-white" >
      ...
      <header className="header sm:pt-24 pt-10 pl-5 w-full sm:pl-10 bg-white">
        <div className='flex  justify-between'>
            ...
            <img alt='lodo' className='w-2/5 hidden sm:block' src={require('./images/img.webp')}></img>
        </div>
        ...
        <div className="flex  gap-12 sm:gap-24 mb-6 pr-5 w-full">
            {/* List a place */}
            <div className="w-1/2 sm:2/5 relative cursor-pointer hover:shadow-xl h-48  overflow-hidden rounded-es-[5rem] rounded-se-[5rem] shadow-lg flex flex-col items-center justify-center " 
            ><img className='absolute w-full h-full z-0' src={require('./images/list.jpg')}></img>
            <Link to={"/list/:"}><button className="flex items-center gap-2 relative z-5 bg-gray-800 text-white px-6 sm:px-16 py-3 rounded-lg font-semibold">
            ...
            {/* Find a place */}
            <div className="w-1/2 sm:2/5 overflow-hidden relative cursor-pointer hover:shadow-xl h-48 bg-gray-200 rounded-lg shadow-lg flex rounded-ss-[5rem] rounded-ee-[5rem] flex-col items-center justify-center">
            <img className='absolute w-full h-full z-0' src={require('./images/find.jpeg')}></img>
                <Link to={"/for-rent/:"}><button className="flex items-center relative z-5 gap-2 bg-gray-800 text-white px-6 sm:px-16 py-3 rounded-lg font-semibold">
                    <BsPlusCircle size={20} />
                    Find a place
                </button></Link>
            </div>
      ...
      {/** view popular cities */}
       ...
       <div className="p-5 sm:py-10 sm:px-12">
        ...
        <div className="p-10  bg-white">
            ...
            <div className="flex justify-between items-center flex-wrap mb-6">
                {/* Logo placeholders */}
                <div className="text-gray-400 m-1 text-xl font-bold">
